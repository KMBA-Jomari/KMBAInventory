...
class SubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subcategory" do
    assert_difference("Subcategory.count") do
      post subcategories_url, params: { subcategory: { category_id: @subcategory.category_id, description_string: @subcategory.description_string, sub_category_name: @subcategory.sub_category_name } }
    end
  ...
  test "should update subcategory" do
    patch subcategory_url(@subcategory), params: { subcategory: { category_id: @subcategory.category_id, description_string: @subcategory.description_string, sub_category_name: @subcategory.sub_category_name } }
